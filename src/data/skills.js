const skills = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "MVC", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/dot-net/dot-net-plain-wordmark.svg" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Hugging\nFace", icon: "https://huggingface.co/front/assets/huggingface_logo-noborder.svg" },
    ],
  },
  {
    ...
    items: [
      ...
      { name: "GIS", icon: "https://img.icons8.com/color/48/geography.png" },
